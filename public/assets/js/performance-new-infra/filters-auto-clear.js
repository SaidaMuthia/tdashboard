console.log('filters loaded on performance new infra')
//
...
// search on filter
$("[name=conndate], [name=last_day], [name=branch], [name=cluster], [name=city]").keyup(function() {
...
// filter item data
$("[name=conndate], [name=last_day], [name=region], [name=branch], [name=city]").on('focus', function(obj) {
